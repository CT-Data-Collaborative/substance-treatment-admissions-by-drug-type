Substance Treatment Admissions by Drug Type

[![Build Status](https://travis-ci.org/CT-Data-Collaborative/substance-treatment-admissions-by-drug-type.svg?branch=master)](https://travis-ci.org/CT-Data-Collaborative/substance-treatment-admissions-by-drug-type)

Substance Treatment Admissions reports the number, rate, and percentage of admissions for substance use and abuse, per substance.
